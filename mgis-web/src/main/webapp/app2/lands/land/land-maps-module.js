	...
	.controller("LandsMapsController", function ($scope, $state, LandsLandService) {
		...
		var landsVectorSource = new ol.source.ServerVector({
			...
			loader: function (extent, resolution, projection) {
				var url = '/proxy?url='+encodeURIComponent('http://localhost:8081/geoserver/mgis2/wfs?service=WFS&version=1.1.0&layers=mgis2:lands_land&request=GetFeature&typeNames=lands_land&bbox=' + extent.join(','));
				console.log("loader");
				$.ajax({
					url: url,
